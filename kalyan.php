...
<body style="background-color: #ffffff">
    ...
    <!-- FORUM STARTS HERE -->
    <div class="basicform">
                <form action="kalyan.php" method="post" name="form">
    ...
    <div class="container">
                    <?php
                        require 'connect.php';
                        $sql1 = "SELECT username,post FROM kalyan";
...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $sqlquery = "INSERT INTO kalyan VALUES('$un','$comment')";
        mysqli_query($conn,$sqlquery);
        header('location: kalyan.php');
